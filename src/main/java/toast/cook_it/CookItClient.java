...
import toast.cook_it.block.PlateEntityRenderer;
import toast.cook_it.block.baking_sheet.BakingSheetEntityRenderer;
import toast.cook_it.block.cooking_block.CookingBlockRenderer;
...
public class CookItClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockEntityRendererRegistry.register(CookItBlocks.PLATE_ENTITY, PlateEntityRenderer::new);
