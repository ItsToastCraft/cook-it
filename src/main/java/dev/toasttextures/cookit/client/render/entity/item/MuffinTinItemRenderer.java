...
import dev.toasttextures.cookit.client.render.entity.MuffinTinEntityRenderer;
...
public class MuffinTinItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    public void render(ItemStack stack, ItemDisplayContext mode, PoseStack matrices, MultiBufferSource vertexConsumers, int light, int overlay) {
        ...
        MuffinTinEntityRenderer.render(Container.getItems(stack), matrices, vertexConsumers, null, light, overlay);
    }
}