...
public class Fryer extends BlockWithEntity implements BlockEntityProvider {
    private static final VoxelShape NORTH_SOUTH_SHAPE = createCuboidShape(3.0, 0.0, 1.0, 13.0, 8.0, 15.0);
    private static final VoxelShape EAST_WEST_SHAPE = createCuboidShape(1.0, 0.0, 3.0, 15.0, 8.0, 13.0);
