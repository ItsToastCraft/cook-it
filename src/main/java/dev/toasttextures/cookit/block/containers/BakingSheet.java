...
public class BakingSheet extends Block implements BlockEntityProvider {
    ...
    @Override
    public void appendTooltip(ItemStack stack, BlockView world, List<Text> tooltip, Item.TooltipContext context) {

        BlockEntity nbt = stack.getComponents().get(DataComponentTypes.BLOCK_ENTITY_DATA)
