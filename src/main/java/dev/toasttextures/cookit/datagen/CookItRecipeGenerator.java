    ...
    public void generate(RecipeExporter exporter) {
        for (Plate plate : CookItBlocks.PLATES) {
            ...
            ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, plate).pattern("ccc")
                    .input('c', Registries.BLOCK.get(Identifier.of("minecraft", color + "_concrete")))
        ...
        for (Block cuttingBoard : CookItBlocks.CUTTING_BOARDS) {
            ...
            Block slab = Registries.BLOCK.get(Identifier.of("minecraft", woodType + "_slab"));
        ...
        for (Item rollingPin : ROLLING_PINS) {
            ...
            Block planks = Registries.BLOCK.get(Identifier.of("minecraft", woodType + "_planks"));
            ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, rollingPin).pattern("b").pattern("p").pattern("b")
                    .input('b', Registries.BLOCK.get(Identifier.of("minecraft", woodType + "_button")))
                    .input('p', planks)
